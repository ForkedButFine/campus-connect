...
export default function App() {
  ...
  const renderPage = () => {
    switch (currentPage) {
      ...
      case 'jobs':
        return <JobPlacement currentUser={currentUser} onNavigate={setCurrentPage} onLogout={handleLogout} />;
      case 'funding':
        return <ProjectFunding currentUser={currentUser} onNavigate={setCurrentPage} onLogout={handleLogout} />;
      case 'antiragging':
        return <AntiRagging currentUser={currentUser} onNavigate={setCurrentPage} onLogout={handleLogout} />;
      case 'friendfinder':
        return <FriendFinder currentUser={currentUser} onNavigate={setCurrentPage} onLogout={handleLogout} />;
      case 'marketplace':
        return <Marketplace currentUser={currentUser} onNavigate={setCurrentPage} onLogout={handleLogout} />;
      case 'studygroups':
        return <StudyGroups currentUser={currentUser} onNavigate={setCurrentPage} onLogout={handleLogout} />;
      case 'lostandfound':
        return <LostAndFound currentUser={currentUser} onNavigate={setCurrentPage} onLogout={handleLogout} />;
      case 'campusmap':
        return <CampusMap currentUser={currentUser} onNavigate={setCurrentPage} onLogout={handleLogout} />;
      case 'skillexchange':
        return <SkillExchange currentUser={currentUser} onNavigate={setCurrentPage} onLogout={handleLogout} />;
      case 'qna':
        return <QnABoard currentUser={currentUser} onNavigate={setCurrentPage} onLogout={handleLogout} />;
      case 'alumni':
        return <Alumni currentUser={currentUser} onNavigate={setCurrentPage} onLogout={handleLogout} />;
      default:
        return <Login onLogin={handleLogin} onNavigate={setCurrentPage} loginBg={loginBg} />;
    }
  };
